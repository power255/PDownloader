...
class Downloader:
    ...
    def start(self, url, target_file, urlhandler=lambda u: u):
        ...
        try:
            ...
            if self.__enable_log:
                print("{}下载完成. 总计用时:{}秒".format(url,span - 0.5))
            return 1
...
if __name__ == '__main__':
    ...
    cc = DOWNLOADER.start(url="http://mirrors.163.com/centos/7/isos/x86_64/CentOS-7-x86_64-DVD-1804.iso",
        target_file="c://CentOS-7-x86_64-DVD-1708.iso")
    print(cc)
